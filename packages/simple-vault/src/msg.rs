...
pub enum ExtensionExecuteMsg {
    ...
    /// Execute a Simple vault specific message.
    Simple(SimpleExtensionExecuteMsg),
...
#[cw_serde]
pub enum SimpleExtensionExecuteMsg {
...
/// vaults, but not part of the standard.
#[cw_serde]
pub enum SimpleExtensionQueryMsg {
...
pub enum ExtensionQueryMsg {
    ...
    Simple(SimpleExtensionQueryMsg),
}
