...
/// SimpleVault is a wrapper around BaseVault that implements
/// autocompounding functionality.
pub struct SimpleVault<'a, S, P, V> {
...
impl<'a, S, P, V> Default for SimpleVault<'a, S, P, V> {
    fn default() -> Self {
        Self {
...
impl<S, P, V> SimpleVault<'_, S, P, V>
where
